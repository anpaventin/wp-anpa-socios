...
final class Test_ANPA_Socios_Csv_Roundtrip_Contracts extends TestCase {
	...
	public function test_fictitious_export_row_parses_and_analyzes( string $entity, array $row ): void {
		$headers = self::export_columns()[ $entity ];
	...
	public static function roundtrip_rows(): array {
		return array(
			...
			'fillos' => array( 'fillos', array( 'proxenitor_email' => 'familia@example.com', 'nome' => 'Lúa', 'apelidos' => 'Exemplo', 'data_nacemento' => '2018-03-15', 'curso' => '1', 'aula' => 'A', 'image_consent' => '1', 'estado' => 'activo' ) ),
			...
			'actividades' => array( 'actividades', array( 'empresa_email' => 'empresa@example.com', 'nome' => 'Actividade Exemplo', 'descripcion' => 'Descrición', 'curso_escolar' => '2026/2027', 'min_pupilos' => '5', 'max_pupilos' => '15', 'curso_min' => '1', 'curso_max' => '6', 'custo' => '20', 'estado' => 'activo' ) ),
