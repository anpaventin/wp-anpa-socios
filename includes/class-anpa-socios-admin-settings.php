...
final class ANPA_Socios_Admin_Settings {
	...
	public static function render_docs_page(): void {
		...
		$li( __( 'Grupos e horarios amosa a ocupación de cada grupo (inscritos, lista de espera, pendentes e mínimo) e, coas matrículas pechadas, botóns por grupo aberto (coas matrículas abertas non aparecen): «Notificar grupo creado (comezo do trimestre)», sempre (correo ás familias inscritas e á empresa, e outro ás de lista de espera; a empresa pode formar o grupo aínda sen o mínimo), e «Pechar por non acadar o mínimo», só cando non se acada (o grupo queda deshabilitado e desaparece da oferta e da área; as súas matrículas pasan a baixa e avísase por correo). Os grupos pechados ou deshabilitados vense sombreados na grella, só con «Editar».', 'anpa-socios' ) );
