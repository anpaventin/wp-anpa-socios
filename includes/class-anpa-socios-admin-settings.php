...
final class ANPA_Socios_Admin_Settings {
	...
	public static function render_docs_page(): void {
		...
		$li( __( 'Grupos e horarios amosa a ocupación de cada grupo (inscritos, lista de espera, pendentes e mínimo) e, coas matrículas pechadas, dous botóns por grupo aberto (coas matrículas abertas non aparecen): «Notificar grupo creado (comezo do trimestre)» (correo ás familias inscritas e á empresa, e outro ás de lista de espera) e «Pechar por non acadar o mínimo» (o grupo queda deshabilitado e desaparece de Grupos e horarios, da oferta e da área; as súas matrículas pasan a baixa e avísase por correo; pódese reactivar dende a ficha da actividade).', 'anpa-socios' ) );
